...
class PL_Admin_Bar{
  ...
  function __construct() {
    ...
    /**
     * Added in 153 left in case we need it later.
     */
    //add_action( 'admin_bar_menu', array( $this, 'admin_bar_extend' ), 221 );
  }
  ...
  /**
   * Add the extend link to main admin bar.
   */
  function admin_bar_extend() {

    global $wp_admin_bar;

    $wp_admin_bar->add_menu( array(
        'id'        => 'pl-ab-extend-button',
        'parent'    => '',
        'title'     => '<i class="pl-icon pl-icon-cloud-download"></i>',
        'meta'      => array( 'title' => 'Extend PageLines' ),
        'href'      => PL_Platform()->url( 'extend' ),
    ));
  }
