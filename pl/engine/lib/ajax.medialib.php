...
class PL_Media_Library{
  ...
  function __construct() {
    ...
    if ( isset( $_REQUEST['context'] ) && 'platform-custom-attach' == $_REQUEST['context'] ) {
  ...
  function pl_media_library_link( $type = 'image' ) {
    ...
    $image_library_url = add_query_arg( array( 'context' => 'platform-custom-attach', 'TB_iframe' => 1 ), $image_library_url );
