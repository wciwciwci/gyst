...
if ( ! class_exists( 'PL_Site_Engine' ) ) {
  ...
  class PL_Site_Engine{
    ...
    function admin_scripts() {
      ...
      pl_script( 'pl-admin',      pl_framework_url( 'js' )  . '/admin.js',  array( 'jquery', 'wp-color-picker' ) );
      pl_enqueue_components();
      pl_style( 'pl-admin',       pl_framework_url( 'css' ) . '/admin.css' );
      ...
      $config = apply_filters('pl_admin_json', array(
          ...
          'safemode'      => PL_Platform()->extend_safemode(),
      ));
